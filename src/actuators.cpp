...
float rads(float degrees){return (degrees/180)*3.14159;}
float degs(float radians){return (radians/3.14159)*180;}
...
SG_error_t calculate_FBD_forces(robot_requirements_t i, FBD_forces_t *o)
{
    ...
    o->F_i = i.mass*(i.max_vel/i.acceleration_time);
    o->F_net = o->F_i+ o->F_gx + o->F_fric;
    return SUCCESS;
}
